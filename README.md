...
10. verticalScrollbarStyle and horizontalScrollbarStyle are a ScrollbarStyle class object which allows customizing isAlwaysShown, thumbColor, thickness and radius. Default is using system style scrollbar. And since RawScrollbar is not available on stable flutter channel. Full customize function only in beta version.
